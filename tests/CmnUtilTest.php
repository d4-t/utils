...
+-----+-----+------+';
    ...
    public function providerGetStrLangByUnicodeRange()
    {
        ...
        return [
            ...
            ["mb_substr: Performs a multi-byte safe substr() operation based on number of characters. Position is counted from the beginning of str. First character's position is 0. Second character position is 1, and so on." . PHP_EOL
                . "Example: mb_substr('你好',1) returns '好'", null, ['en' => 0.9689119170984456, 'zh' => 0.015544041450777202]],
